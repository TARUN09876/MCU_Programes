...
/* USER CODE BEGIN Header_StartLED_04 */
/**
...
/* USER CODE BEGIN Header_StartLED_07 */
/**
...
void StartLED_07(void const * argument)
{
  ...
  /* USER CODE END StartLED_07 */
}

/* USER CODE BEGIN Header_StartTLED_08 */
/**
